...
/**
 * Created by arunditti on 5/14/18.
 */
...
public class DatabaseTest {
    ...
    private final Class mDbHelperClass = FavoritesDbHelper.class;
    ...
    public void create_database_test() throws Exception{
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                FavoritesContract.FavoriteEntry.TABLE_NAME, tableNameCursor.getString(0));
